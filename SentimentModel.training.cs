...
namespace EvaluadorInteligente
{
    public partial class SentimentModel
    {
        public const string RetrainFilePath =  @"C:\Users\USUARIO\Downloads\sentiment-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Text",outputColumnName:@"Text")      
                                    ...
                                    .Append(mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=4,FeatureFraction=1F,LabelColumnName=@"Label",FeatureColumnName=@"Features"}))      
                                    .Append(mlContext.BinaryClassification.Calibrators.Naive(labelColumnName:@"Label",scoreColumnName:@"Score"));
