...
namespace SentimentModel.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\USUARIO\EvaluadorInteligente\Data\sentiment-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Text",outputColumnName:@"Text")      
                                    ...
                                    .Append(mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=11,MinimumExampleCountPerLeaf=3,NumberOfTrees=4,MaximumBinCountPerFeature=133,FeatureFraction=0.9548263809227739,LearningRate=0.9999997766729865,LabelColumnName=@"Label",FeatureColumnName=@"Features",DiskTranspose=false}));
